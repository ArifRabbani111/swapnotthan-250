...
If you'd like, I can add a minimal CONTRIBUTING.md and some example API cURL calls.
...
- Generate example API requests (cURL/Postman) for each endpoint.
- Start the application here and verify it boots (if you want me to run it locally).
# Swapnotthan
